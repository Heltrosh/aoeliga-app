...
DELETE FROM tournament_setup_matches;
DELETE FROM tournament_setup_player_assignments;
...
VALUES
  ...
  (
    ...
    'summer-signup-2026',
    'Summer Signup 2026',
    'Dev seed tournament in signup phase for registration UI testing',
    'signup',
    1,
    1,
    30,
...
-- REGISTRATIONS
-- Note:
-- - tournament 1 registrations are historical / active tournament data
-- - tournament 2 registrations are for signup-phase testing
-- ============================================================
